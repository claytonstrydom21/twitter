<template>
    <div class="flex flex-col items-center space-y-6 w-full">
        <h2 class="text-2xl font-bold">Sign in to X</h2>

        <div class="w-2/3 flex flex-col items-center space-y-6">
            <google-button class="w-full" />
            <apple-button class="w-full" />

            <or-divider class="w-full"/>
            ...
            <button
                @click="nextStep"
                class="w-full rounded-full bg-white px-4 py-2 text-black font-medium hover:bg-gray-200 disabled:opacity-50"
